        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <form action="{{ url('prov_jawabarat/'. $jawabarat_locs->id_kabupaten_jawabarat) }}" method="POST">
                        @method('PATCH')
                        @csrf
