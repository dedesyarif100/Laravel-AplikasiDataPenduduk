        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    <li><a href="#">Tambah Data Jawa Timur</a></li>
    ...
    <div class="animated fadeIn">
        <div class="card">
            <div class="card-header">
                <div class="pull-left">
                    <strong>Tambah Data Jawa Timur</strong>
                </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <form action="{{ url('jawatimur/prov_jawatimur') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label>Nama Kabupaten</label>
                            <input type="text"
                                name="nama_kabupaten_jawatimur"
                                value="{{ old('nama_kabupaten_jawatimur') }}"
                                class="form-control @error('nama_kabupaten_jawatimur') is-invalid @enderror"
                                autofocus>
