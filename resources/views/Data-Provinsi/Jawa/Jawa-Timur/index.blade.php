    ...
    <div class="content mt-3">
        <div class="animated fadeIn">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="pull-right">
                        <a href="{{ url('jawatimur/prov_jawatimur/trash') }}" class="btn btn-danger btn-sm">
                            <i class="fa fa-trash"></i> Trash
                        </a>
                        <a href="{{ url('jawatimur/prov_jawatimur/create') }}" class="btn btn-success btn-sm">
            ...
            <div class="card-body table-responsive">
                ...
                <div class="pull-left">
                    Showing
                    {{ $jawatimur_locs->firstItem() }}
                    to
                    {{ $jawatimur_locs->lastItem() }}
                    of
                    {{ $jawatimur_locs->total() }}
                    entries
                </div>
                <div class="pull-right">
                    {{ $jawatimur_locs->links() }}
                </div>
            </div>
        </div>
    </div>
