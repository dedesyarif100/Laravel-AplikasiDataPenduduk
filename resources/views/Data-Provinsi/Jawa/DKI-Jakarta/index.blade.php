            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="pull-right">
                        ...
                        <a href="{{ url('jakarta/prov_jakarta/create') }}" class="btn btn-success btn-sm">
                        ...
                        @if ($jakarta_locs->count() > 0)
                            @foreach ($jakarta_locs as $key => $item)
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <a href="{{ url('jakarta/prov_jakarta/'.$item->id_provinsi_jakarta) }}"
                                            class="btn btn-warning btn-sm">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="{{ url('jakarta/prov_jakarta/'.$item->id_provinsi_jakarta . '/edit') }}"
                                            class="btn btn-primary btn-sm">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <form action="{{ url('jakarta/prov_jakarta/'.$item->id_provinsi_jakarta) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus data?')">
                                            @method('delete')
                                            @csrf
