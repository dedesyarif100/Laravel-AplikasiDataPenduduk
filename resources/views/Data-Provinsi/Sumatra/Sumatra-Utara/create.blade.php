        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <form action="{{ url('sumatra-utara/prov_sumatra-utara') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label>Nama Kabupaten</label>
                            <input type="text"
                                name="nama_kabupaten_sumatrautara"
                                value="{{ old('nama_kabupaten_sumatrautara') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="luas_wilayah_sumatrautara" value="{{ old('luas_wilayah_sumatrautara') }}" class="form-control @error('luas_wilayah_sumatrautara') is-invalid @enderror" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="total_penduduk_sumatrautara" value="{{ old('total_penduduk_sumatrautara') }}" class="form-control @error('total_penduduk_sumatrautara') is-invalid @enderror" autofocus>
