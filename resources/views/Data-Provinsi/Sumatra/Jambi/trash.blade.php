        ...
        <div class="animated fadeIn">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="pull-left">
                        <strong>Data Kabupaten Jambi Terhapus</strong>
                    </div>
                    <div class="pull-right">
                        {{-- <a href="{{ url('prov_jawabarat/delete') }}" class="btn btn-danger btn-sm">
                            <i class="fa fa-trash"></i> Delete All
                        </a> --}}
                        <form action="{{ url('jambi/prov_jambi/delete/') }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus data?')">
                            @method('delete')
                            @csrf
                        ...
                        <a href="{{ url('jambi/prov_jambi/restore') }}" class="btn btn-info btn-sm">
                            ...
                            @foreach ($jambi_locs as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('jambi/prov_jambi/restore/'.$item->id_kabupaten_jambi) }}" class="btn btn-info btn-sm">
                                            Restore
                                        </a>
                                        ...
                                        <form action="{{ url('jambi/prov_jambi/delete/'.$item->id_kabupaten_jambi) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus data?')">
                                            @method('delete')
                                            @csrf
                                            <button class="btn btn-danger btn-sm">
                                                Delete Kab Permanent
