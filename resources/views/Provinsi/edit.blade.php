    ...
    <div class="animated fadeIn">
        <div class="card">
            <div class="card-header">
                <div class="pull-left">
                    <strong>Edit Data Provinsi</strong>
                </div>
                ...
                <div class="col-md-4 offset-md-4">
                    <form action="{{ url('provinsi/provinsi/'. $dataProvinsi->id_provinsi) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                name="nama_provinsi"
                                value="{{ old('nama_provinsi', $dataProvinsi->nama_provinsi) }}"
                                class="form-control @error('nama_provinsi') is-invalid @enderror" autofocus>
                            @error('nama_provinsi')
